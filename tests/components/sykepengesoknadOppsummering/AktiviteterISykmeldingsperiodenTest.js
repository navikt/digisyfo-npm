...
describe("AktiviteterISykmeldingsperioden (Oppsummering)", () => {
    ...
    describe("Aktiviteter", () => {
        ...
        it("Skal sende arbeidsgiver videre til hver Aktivitet", () => {
            expect(component.find(Aktivitet).first().prop("arbeidsgiver")).to.equal("***REMOVED***")
        })
    ...
    describe("Periode med gradering", () => {
        ...
        describe("Uten avvik", () => {
            beforeEach(() => {
                ...
                component = mount(<Aktivitet  arbeidsgiver="***REMOVED***" ledetekster={ledetekster} aktivitet={soknad.aktiviteter[1]} />);
            });
    ...
    describe("Periode uten gradering uten avvik", () => {
        ...
        beforeEach(() => {
            ...
            component = render(<Aktivitet ledetekster={ledetekster} arbeidsgiver="***REMOVED***" aktivitet={soknad.aktiviteter[0]} />);
        })
    ...
    describe("Inntektskilder", () => {
        ...
        describe("Hvis man ikke har andre inntektskilder", () => {
            ...
            it("Skal vise spørsmål om inntektskilder", () => {
                expect(component.text()).to.contain("Har du andre inntektskilder enn ***REMOVED***");
                expect(component.text()).to.contain("Nei")
            });
